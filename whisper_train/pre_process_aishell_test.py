...
if __name__ == '__main__':
    ...
    audio_directory = '/home/fengruitao/rt_nas/data/AISHELL-DEV-TEST-SET/iOS/test/wav'
    transcription_file = '/home/fengruitao/rt_nas/data/AISHELL-DEV-TEST-SET/iOS/test/trans.txt'
    output_dataset_path = '/home/fengruitao/rt_nas/data/processed_aishell_test/'

    whisper_feature_extractor = WhisperFeatureExtractor.from_pretrained("/home/autodl/autodl-tmp-bak/model/whisper-large-v3")
    # whisper_encoder = WhisperEncoder("/root/autodl-tmp/model/whisper-large-v3")
    llm_tokenizer=AutoTokenizer.from_pretrained("/home/autodl/autodl-tmp-bak/model/Qwen2.5-0.5B-Instruct/")
