...
from steer_moe.models import SteerMoEEfficientLayerWiseModelLinear
...
def load_custom(path, whisper_encoder, llm_decoder, **kwargs):
    model = SteerMoEEfficientLayerWiseModelLinear(
...
def analyze_steering_patterns(model_path: str):
    ...
    model = SteerMoEEfficientLayerWiseModelLinear.from_pretrained(model_path)
